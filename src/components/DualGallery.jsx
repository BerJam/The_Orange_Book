  ...
  return (
    ...
    >
      ...
      <div className="fixed top-6 left-6 z-50">
        <span className="font-sans text-[9px] uppercase tracking-[2px] text-[#888]">
          {isRawMode ? "MODO: CORROMPIDO" : "MODO: SERENO"}
        </span>
      </div>

      <div className="fixed top-6 right-6 z-50">
        <span className="font-sans text-[8px] uppercase tracking-[1px] text-[#ccc]">
      ...
      {!isRawMode ? (
        ...
        <div className="mx-auto max-w-4xl px-6 pt-32 pb-20">
          <div className="mb-24 text-center">
            <h2 className="font-sans text-2xl font-light uppercase tracking-[6px] text-[#111] md:text-4xl">
              Arquivo Oficial
            </h2>
            <p className="mt-6 font-sans text-[10px] uppercase tracking-[2px] text-[#888]">
          ...
          <div className="grid grid-cols-1 gap-20 md:grid-cols-2">
            {[1, 2, 3, 4].map((item) => (
              <div key={`clean-${item}`} className="flex flex-col items-center">
                ...
                <p className="mt-4 font-sans text-[10px] uppercase tracking-[2px] text-[#333]">
        ...
        <div className="relative min-h-[150vh] w-full overflow-hidden pt-32 pb-20">
          <div className="mb-12 px-6 text-left">
             <h2 className="font-sans text-4xl font-bold uppercase tracking-tighter text-[#111] mix-blend-multiply md:text-7xl">
              [ RAW_DATA ]
            </h2>
          </div>
          ...
          <motion.div initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="absolute top-[40%] right-[5%] z-10 w-[50%] md:w-[25%]">
            ...
            <p className="absolute -top-4 right-0 font-sans text-[10px] text-red-600">TESTE_COR_04.jpg</p>
          </motion.div>
      ...
      <button 
        onClick={toggleMode}
        className="fixed bottom-6 right-6 z-50 border-b border-[#111] pb-1 font-sans text-[9px] uppercase tracking-[2px] text-[#111] transition-opacity hover:opacity-50 hidden md:block"
      >
